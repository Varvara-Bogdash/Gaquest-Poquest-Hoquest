...
public class FightActivity3 extends AppCompatActivity {
    ImageView imageView;
    Boolean winOrNot;
    String name1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Objects.equals(name1, "Гермиона Грейнджер")) {
            ...
            countClickImp = 4;
            countClickChit = 1;
            textViewHero.setText("Гермиона Грейнджер (сила - 80/100; усиления: круциатус - 4, адава кедавра - 5, империус - 4, оборонительное заклинание - 1; здоровье - 100/100;)");
        } else {
            if (Objects.equals(name1, "Рон Уизли")) {
                ...
                countClickImp = 2;
                countClickChit = 3;
                textViewHero.setText("Рон Уизли (сила - 70/100; усиления: круциатус - 2, адава кедавра - 10, империус - 2, оборонительное заклинание - 3; здоровье - 100/100;)");
            } else {
                ...
                countClickImp = 1;
                countClickChit = 5;
                textViewHero.setText("Гарри Поттер (сила - 90/100; усиления: круциатус - 3, адава кедавра - 3, империус - 1, оборонительное заклинание - 5; здоровье - 100/100;)");
            }
        }
    ...
    public void krucio(View view) throws InterruptedException {
        if (countClickKru == 1) {
            ...
            if (healthDementor == 0){
                ...
                winOrNot = true;
                Intent intent = new Intent(this, LevelActivity4.class);
    ...
    private void dementorFight() {
        ...
        if (random == 0){
            ...
            textViewFight.append("Амбридж душит тебя.  ");
            textViewDementor.setText("Долотес Амбридж(сила - 30/100; усиления(каждое уменьшает здоровье на 10): душит тебя - "+countOfSmell+", управляет тобой - "+countOfPut+", розовое все - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
        } else {
            if (random == 1){
                healthHero= healthHero - 10;
                countOfPut = countOfPut - 1;
                textViewFight.append("Амбридж управляет тобой.  ");
                textViewDementor.setText("Долотес Амбридж(сила - 30/100; усиления(каждое уменьшает здоровье на 10): душит тебя - "+countOfSmell+", управляет тобой - "+countOfPut+", розовое все - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");

            }else {
                healthHero= healthHero - 10;
                countOfTransform = countOfTransform - 1;
                textViewFight.append("Все розовое.  ");
                textViewDementor.setText("Долотес Амбридж(сила - 30/100; усиления(каждое уменьшает здоровье на 10): душит тебя - "+countOfSmell+", управляет тобой - "+countOfPut+", розовое все - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
