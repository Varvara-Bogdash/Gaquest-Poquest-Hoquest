...
public class FightActivity5 extends AppCompatActivity {
    ...
    private void dementorFight() {
        ...
        if (random == 0){
            ...
            textViewFight.append("Драко обозвал тебя.  ");
            textViewDementor.setText("Драко Малфой (сила - 50/100; усиления(каждое уменьшает здоровье на 10): обозвал тебя - "+countOfSmell+", круцио - "+countOfPut+", съедает и выплевывает тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
        } else {
            if (random == 1){
                healthHero= healthHero - 10;
                countOfPut = countOfPut - 1;
                textViewFight.append("Драко использовал круцио.  ");
                textViewDementor.setText("Драко Малфой (сила - 50/100; усиления(каждое уменьшает здоровье на 10): обозвал тебя - "+countOfSmell+", круцио - "+countOfPut+", съедает и выплевывает тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");

            }else {
                healthHero= healthHero - 10;
                countOfTransform = countOfTransform - 1;
                textViewFight.append("Драко поел и выплюнул тебя.  ");
                textViewDementor.setText("Драко Малфой (сила - 50/100; усиления(каждое уменьшает здоровье на 10): обозвал тебя - "+countOfSmell+", круцио - "+countOfPut+", съедает и выплевывает тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
