...
public class FightActivity10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Objects.equals(name1, "Гермиона Грейнджер")) {
            ...
            countClickImp = 6;
            countClickChit = 3;
            textViewHero.setText("Гермиона Грейнджер (сила - 80/100; усиления: круциатус - 4, адава кедавра - 7, империус - 6, оборонительное заклинание - 3; здоровье - 100/100;)");
        } else {
            if (Objects.equals(name1, "Рон Уизли")) {
                ...
                countClickImp = 4;
                countClickChit = 5;
                textViewHero.setText("Рон Уизли (сила - 70/100; усиления: круциатус - 2, адава кедавра - 12, империус - 4, оборонительное заклинание - 5; здоровье - 100/100;)");
            } else {
                ...
                countClickImp = 3;
                countClickChit = 7;
                textViewHero.setText("Гарри Поттер (сила - 90/100; усиления: круциатус - 3, адава кедавра - 5, империус - 3, оборонительное заклинание - 7; здоровье - 100/100;)");
            }
        }
    ...
    private void dementorFight() {
        ...
        if (random == 0){
            ...
            textViewFight.append("Том истользовал адава кедавра.  ");
            textViewDementor.setText("Том Редлл (сила - 70/100; усиления(каждое уменьшает здоровье на 10): адава кедавра - "+countOfSmell+", волшебный дневник - "+countOfPut+", заговаривает зубы - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
        } else {
            if (random == 1){
                healthHero= healthHero - 10;
                countOfPut = countOfPut - 1;
                textViewFight.append("Том использовал волшебный дневник.  ");
                textViewDementor.setText("Том Редлл (сила - 70/100; усиления(каждое уменьшает здоровье на 10): адава кедавра - "+countOfSmell+", волшебный дневник - "+countOfPut+", заговаривает зубы - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");

            }else {
                healthHero= healthHero - 10;
                countOfTransform = countOfTransform - 1;
                textViewFight.append("Том заговорил зубы.  ");
                textViewDementor.setText("Том Редлл (сила - 70/100; усиления(каждое уменьшает здоровье на 10): адава кедавра - "+countOfSmell+", волшебный дневник - "+countOfPut+", заговаривает зубы - "+countOfTransform+";) здоровье - "+healthDementor+"/100;");
