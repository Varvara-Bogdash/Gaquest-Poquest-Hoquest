...
public class FightActivity4 extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (Objects.equals(name1, "Гермиона Грейнджер")) {
                ...
                countClickImp = 4;
                countClickChit = 2;
                textViewHero.setText("Гермиона Грейнджер (сила - 80/100; усиления: круциатус - 3, адава кедавра - 5, империус - 4, оборонительное заклинание - 2; здоровье - 100/100;)");
            } else {
                if (Objects.equals(name1, "Рон Уизли")) {
                    ...
                    countClickImp = 2;
                    countClickChit = 4;
                    textViewHero.setText("Рон Уизли (сила - 70/100; усиления: круциатус - 1, адава кедавра - 10, империус - 2, оборонительное заклинание - 4; здоровье - 100/100;)");
                } else {
                    ...
                    countClickImp = 1;
                    countClickChit = 6;
                    textViewHero.setText("Гарри Поттер (сила - 90/100; усиления: круциатус - 2, адава кедавра - 3, империус - 1, оборонительное заклинание - 6; здоровье - 100/100;)");
                }
            }
        ...
        public void krucio(View view) throws InterruptedException {
            if (countClickKru == 1) {
                ...
                if (healthDementor == 0){
                    ...
                    winOrNot = true;
                    Intent intent = new Intent(this, LevelActivity5.class);
        ...
        private void dementorFight() {
            ...
            if (random == 0){
                ...
                textViewFight.append("Снейп дал вам странное зелье.  ");
                textViewDementor.setText("Северус Снейп (сила - 40/100; усиления(каждое уменьшает здоровье на 10): странное зелье - "+countOfSmell+", забирает Дамблдора - "+countOfPut + ", бросает предметы в тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100");
            } else {
                if (random == 1){
                    healthHero= healthHero - 10;
                    countOfPut = countOfPut - 1;
                    textViewFight.append("Снейп забрал Дамблдора.  ");
                    textViewDementor.setText("Северус Снейп (сила - 40/100; усиления(каждое уменьшает здоровье на 10): странное зелье - "+countOfSmell+", забирает Дамблдора - "+countOfPut + ", бросает предметы в тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100");

                }else {
                    healthHero= healthHero - 10;
                    countOfTransform = countOfTransform - 1;
                    textViewFight.append("Снейп бросил в тебя предмет.  ");
                    textViewDementor.setText("Северус Снейп (сила - 40/100; усиления(каждое уменьшает здоровье на 10): странное зелье - "+countOfSmell+", забирает Дамблдора - "+countOfPut + ", бросает предметы в тебя - "+countOfTransform+";) здоровье - "+healthDementor+"/100");
